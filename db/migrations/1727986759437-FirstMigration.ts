...
export class FirstMigration1727986759437 implements MigrationInterface {
    name = 'FirstMigration1727986759437'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "addresses" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "postalCode" integer NOT NULL, "street" character varying NOT NULL, "state" character varying NOT NULL, "coords" jsonb NOT NULL, "geometry" jsonb NOT NULL, CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "aecos" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "status" "public"."aecos_status_enum" NOT NULL DEFAULT 'disabled', "isOnline" boolean NOT NULL DEFAULT false, "serialNumber" character varying NOT NULL, "currentCoords" jsonb, "companyId" integer NOT NULL, "addressId" integer NOT NULL, CONSTRAINT "UQ_e71191c693d7d69a358286625ba" UNIQUE ("serialNumber"), CONSTRAINT "PK_6587143ff4628dcad0daa021404" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_company_permissions_role_enum" AS ENUM('admin', 'user', 'guest')`);
        await queryRunner.query(`CREATE TABLE "user_company_permissions" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "permissions" jsonb, "role" "public"."user_company_permissions_role_enum" NOT NULL, "userId" integer NOT NULL, "companyId" integer NOT NULL, CONSTRAINT "PK_009a581f526624f0dde6026a768" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "companies" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "name" character varying(100) NOT NULL, "rfc" character varying(13) NOT NULL, CONSTRAINT "UQ_3dacbb3eb4f095e29372ff8e131" UNIQUE ("name"), CONSTRAINT "UQ_c0eaf27eab430da819643655682" UNIQUE ("rfc"), CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "companies_users" ("companiesId" integer NOT NULL, "usersId" integer NOT NULL, CONSTRAINT "PK_1d39df00108e9dce5dab8cd2ede" PRIMARY KEY ("companiesId", "usersId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_0dccb27846f465f953da45116d" ON "companies_users" ("companiesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_27f57cf3e8c869fadd4dd25e98" ON "companies_users" ("usersId") `);
        ...
        await queryRunner.query(`ALTER TABLE "user_company_permissions" ADD CONSTRAINT "FK_92e0f63ddf1063e4e6c3bfdaefa" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_company_permissions" ADD CONSTRAINT "FK_c84c3b7d4b40994763b902739e6" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "companies_users" ADD CONSTRAINT "FK_0dccb27846f465f953da45116d9" FOREIGN KEY ("companiesId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "companies_users" ADD CONSTRAINT "FK_27f57cf3e8c869fadd4dd25e984" FOREIGN KEY ("usersId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "companies_users" DROP CONSTRAINT "FK_27f57cf3e8c869fadd4dd25e984"`);
        await queryRunner.query(`ALTER TABLE "companies_users" DROP CONSTRAINT "FK_0dccb27846f465f953da45116d9"`);
        ...
        await queryRunner.query(`ALTER TABLE "user_company_permissions" DROP CONSTRAINT "FK_c84c3b7d4b40994763b902739e6"`);
        await queryRunner.query(`ALTER TABLE "user_company_permissions" DROP CONSTRAINT "FK_92e0f63ddf1063e4e6c3bfdaefa"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_27f57cf3e8c869fadd4dd25e98"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0dccb27846f465f953da45116d"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."user_company_permissions_role_enum"`);
