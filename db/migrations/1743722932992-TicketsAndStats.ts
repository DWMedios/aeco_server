...
export class TicketsAndStats1743722932992 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "product_stats" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "totalCount" integer NOT NULL DEFAULT '0', "productId" integer, CONSTRAINT "PK_7e42e0367a044aeed5997a1932e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "ticket_items" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "quantity" integer NOT NULL DEFAULT '1', "packagingType" character varying NOT NULL, "ticketId" integer, "productId" integer, CONSTRAINT "PK_42c1d9799d0b98de1654a97ef1a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "packaging_stats" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "packagingType" character varying(20) NOT NULL, "totalCount" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_fbfaef283fbd36a17164e452286" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "daily_stats" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "totalTickets" integer NOT NULL DEFAULT '0', "totalBottles" integer NOT NULL DEFAULT '0', "totalCans" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_d1830b57aa5fafc5cb26a09aa73" PRIMARY KEY ("id"))`);
